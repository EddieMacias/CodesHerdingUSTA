       ...
       for t = 1:num_iterations
           ...
           % conexion Enjambre 01
            ...
            trajectory10 (t,:) = [shepherds(4,:), boidAlt];
                ...
                % Calcular posiciones Optimas
                target_R = setOptimTarget(positions,'R',shepherds(4,:),0.1);
                target_L = setOptimTarget(positions,'L',shepherds(2,:),0.1);
                target_U = setOptimTarget(positions,'U',shepherds(1,:),0.1);
                target_D = setOptimTarget(positions,'D',shepherds(3,:),0.1);
