...
%Funcion para entrenar el Agente de acuerdo al entorno y recompensas
function [Q, training_time] = TrainAgent(num_episodios, num_estados, max_recompensa, Q, epsilon, num_acciones, num_filas, num_columnas, R, alpha, gamma)
