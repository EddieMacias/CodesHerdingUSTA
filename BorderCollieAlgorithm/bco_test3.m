...
mejor_aptitud = funcion_objetivo3(ovejas, pastores, radio_objetivo, distancia_minima_pastores);
...
for iter = 1:num_iteraciones
    ...
    aptitud_actual = funcion_objetivo3(ovejas, pastores, radio_objetivo, distancia_minima_pastores);
