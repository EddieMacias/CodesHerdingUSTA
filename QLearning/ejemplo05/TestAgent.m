function TestAgent(estado, max_recompensa, Q, num_acciones, num_filas, num_columnas, R,pos)
    cnt = 1;
    while estado ~= max_recompensa
        ...
        cnt = cnt+1;
        dibujar_gridworld(estado, num_filas, num_columnas, R, max_recompensa,pos);
        pause(0.1);
    end
end